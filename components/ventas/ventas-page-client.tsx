        ...
        <div className="flex w-fit items-stretch">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem asChild>
                <Link href="/ventas/nueva-nc">Nueva nota de credito</Link>
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        </div>
      ...
      >
        ...
        <div className="flex w-full flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div className="flex w-full min-w-0 flex-1 flex-wrap items-center gap-2">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="last">en los ultimos</SelectItem>
                        <SelectItem value="next">en los proximos</SelectItem>
                        <SelectItem value="before">antes de</SelectItem>
                        <SelectItem value="after">despues de</SelectItem>
                      </SelectContent>
                    </Select>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant={currentFilters.status ? "secondary" : "outline"}
                  size="default"
                  className="h-8 justify-start border-dashed"
                >
              ...
              <DropdownMenuContent align="start" className="w-56">
                ...
                <DropdownMenuSub>
                  ...
                  <DropdownMenuSubContent>
                    ...
                    <DropdownMenuItem>NCX - Nota de credito</DropdownMenuItem>
                  </DropdownMenuSubContent>
                </DropdownMenuSub>
              </DropdownMenuContent>
            </DropdownMenu>
        ...
        <div className="flex items-center justify-between px-2">
          <div className="hidden flex-1 text-sm text-muted-foreground md:block">
            Mostrando {sales.length} de {count} resultados
          </div>
