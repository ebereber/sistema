...
} from "@/lib/actions/supplier-payments";
...
interface PagoDetalleClientProps {
  payment: SupplierPayment;
}

export function PagoDetalleClient({ payment }: PagoDetalleClientProps) {
  ...
  const handleCancel = async () => {
    ...
    try {
      await cancelSupplierPaymentAction(payment.id);
  ...
  const handleSaveNote = async () => {
    try {
      await updatePaymentNotesAction(payment.id, tempNote || null);
