...
export function OrdenDetalleClient({ order }: OrdenDetalleClientProps) {
  ...
  const handleConfirm = async () => {
    ...
    try {
      await confirmPurchaseOrderAction(order.id);
  ...
  const handleReceive = async () => {
    ...
    try {
      ...
      await receiveProductsAction(order.id, receivedItems);
  ...
  const showHistory = order.history.length > 0;
          ...
          <div className="flex gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent>
                ...
                <DropdownMenuItem onClick={() => toast.info("Proximamente")}>
                  <Download />
                  Descargar PDF
                </DropdownMenuItem>
                <DropdownMenuItem
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      ...
                      opcion para recibir los productos de tu proveedor luego.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
                ...
                <DialogContent className="max-h-[80vh] overflow-y-auto lg:max-w-3xl">
                  ...
                  <DialogFooter>
                    ...
                    <Button onClick={handleReceive} disabled={isReceiving}>
                      {isReceiving ? "Registrando..." : "Confirmar recepcion"}
                    </Button>
                  </DialogFooter>
                </DialogContent>
              </Dialog>
            ...
            {!isDraft && (
              <Button asChild>
                <Link href={`/compras/nueva?purchaseOrderId=${order.id}`}>
                  <ReceiptText />
                  Crear factura
                </Link>
              </Button>
      ...
      <AlertDialog open={cancelDialogOpen} onOpenChange={setCancelDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              La orden {order.order_number} sera marcada como cancelada. Esta
